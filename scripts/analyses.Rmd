...
```{r}
# rel combined
test_scale_comb <- efa_vars %>%
  select(q41_p1, q43_p1, q44_p1, q50_p1, q58_p1, q62_p1, q63_p1, q64_p1, q65_p1, q66_p1, q67_p1, q126_p1) # removing 18 and 19 because loading less than .30

# EFA rel combined
fa(test_scale_comb, n.obs = NA, rotate = "none", fm = "uls", cor = "poly") # matrix not positive definite, but looks good
```


```{r}
# rel combined
fa.parallel(test_scale_comb, n.obs=NULL, fm="uls", fa="fa", nfactors=1, main="Parallel Analysis Scree Plots", n.iter=20, error.bars=FALSE, se.bars=FALSE, SMC=FALSE, ylabel=NULL, show.legend=TRUE, sim=TRUE, quant=.95, cor="poly", use="pairwise", plot=TRUE, correct=.5) # parallel analysis suggest 3 factors, matrix not positive,  ultra heywood 

# 3 factors 
fa(test_scale_comb, nfactors = 3, n.obs = NA, rotate = "quartimin", fm = "uls", cor = "poly") # 66 was Heywood, other 3 items were crossloading
```

```{r}
# rel combined - EFA 2 factors
fa(test_scale_comb, nfactors = 2, n.obs = NA, rotate = "quartimin", fm = "uls", cor = "poly")
```

```{r}
test_scale_comb_fa1 <- efa_vars %>%
  select(q41_p1, q58_p1, q62_p1, q63_p1, q64_p1, q65_p1, q66_p1, q67_p1)

alpha(test_scale_comb_fa1) #.90

test_scale_comb_fa2 <- efa_vars %>%
  select(q43_p1, q44_p1, q50_p1, q126_p1)

alpha(test_scale_comb_fa2) #.78
```
