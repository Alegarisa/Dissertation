...
alpha(scale_7.1_fa_2) # 0.69 (0.77 if removing 95)

scale_7.1_fa_3 <- efa_vars %>%
  select(q90_p1, q91_p1, q98_p1) # 0.59

alpha(scale_7.1_fa_3)
```
...
# 3 factors
fa(scale_6, nfactors = 3, n.obs = NA, rotate = "quartimin", fm = "uls", cor = "poly")
```
...
alpha(scale_6.fa_1) # 0.80

scale_6.fa_2 <- efa_vars %>%
  select(q72_p1, q73_p1, q75_p1, q80_p1, q81_p1)
