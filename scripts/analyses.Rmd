...
mvn(scale_2, subset = NULL, mvnTest = "hz", univariateTest = "AD", univariatePlot = "histogram") # univariate plots can be outputted when analyzing scales
```
...
#When using the scale, not the poly corr matrix:
#Tucker Lewis Index of factoring reliability =  0.426
#RMSEA index =  0.319  and the 90 % CI are  0.282 0.36
#BIC =  120.07
#i think it's not worth it making model improvements 
```
