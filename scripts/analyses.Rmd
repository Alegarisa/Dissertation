...
```{r}
#Realiability: Homework Involvement (17)
...
```{r}
#Realiability: Structure at home (8)
...
```{r}
#Realiability: School-based involvement 
...
fa.parallel(scale_3, n.obs=NULL, fm="uls", fa="fa", nfactors=1, main="Parallel Analysis Scree Plots", n.iter=20, error.bars=FALSE, se.bars=FALSE, SMC=FALSE, ylabel=NULL, show.legend=TRUE, sim=TRUE, quant=.95, cor="poly", use="pairwise", plot=TRUE, correct=.5) # parrallel analysis suggest 2 factors

# 2 FACTORS
fa(scale_3, nfactors = 2, n.obs = NA, rotate = "quartimin", fm = "uls", cor = "poly") # one factor with 2 items and one item is crossloading
...
```{r}
#reliability parent Belongingness in School (4)
alpha(scale_3.1) # 0.64
```
